...
if (isset($_POST['add_hotel'])) {
    ...
    $targetDir = "stateimg/"; // Directory where the file will be moved
    $targetFile = $targetDir . basename($_FILES["file"]["name"]);
    $result = mysqli_query($conn, "INSERT INTO `state_tb`( `state`, `state_img`)VALUES ('$hotel','$targetFile')");
                                    ...
                                    <form method="POST" enctype="multipart/form-data" insert" class="fade-in">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="inputEmail4" placeholder="Name: XYZ" name="statename">
                                            </div>
                                            <div class="mb-3">

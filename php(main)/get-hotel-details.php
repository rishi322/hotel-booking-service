...
<head>
    ...
    <!-- Title -->
    <title>Hotel Details - JuStay </title>
    <!-- Bootstrap css -->
...
<body>
                ...
                <div class="room_book_item">
                    ...
                    <div class="room_booking_right_side">
                       ...
                       <h3 class="price">Total Costing</h4>
                            ...
                            <p class="room_booking_heading"> ${room.need} room required </p>
                           <div class="mt-5">
    ...
    <div class="offcanvas select_offer_modal offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <form method="POST" action = "room-booking.php" >
                ...
                <div class="side_canvas_wrapper">
                    <div class="travel_date_side">
                        <div class="form-group">
                            ...
                            <input type="date" value="2022-05-05" class="form-control" id="check-in-date">
                        </div>
                    </div>
                    <div class="travel_date_side">
                        <div class="form-group">
                            <label for="dates">Select your travel date</label>
                            <input type="date" value="2022-05-05" class="form-control" id="check-out-date">
                        </div>
                    </div>
                    <input type="hidden" id="type_b_id" value="">
                    <div class="select_person_side">
                        ...
                        <div class="select_person_item">
                            ...
                            <div class="select_person_right">
                                <div class="button-set">
                                    <button type="button" id="p_edit">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                    <span id="edits">01</span>
                                    <button type="button" id="m_edit">
                                        <i class="fas fa-minus"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="select_person_item">
                            ...
                            <div class="select_person_right">
                                <div class="button-set">
                                    <button type="button" id="p_child">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                    <span id="d_child">0</span>
                                    <button type="button" id="minus_childs">
                                        <i class="fas fa-minus"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="select_person_item">
                            ...
                            <div class="select_person_right">
                                <div class="button-set">
                                    <button type="button" id="p_infant">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                    <span id="d_infant">0</span>
                                    <button type="button" id="m_infant">
                                        <i class="fas fa-minus"></i>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="write_spical_not">
                            ...
                            <textarea rows="5" class="form-control" placeholder="Write any special note" id="texts"></textarea>
                        </div>
            ...
            <div class="proceed_booking_btn ">
                <button type="submit" class="btn btn_theme btn_md w-100">Proceed to Booking</button>
            </div>
        </form>
    </div>

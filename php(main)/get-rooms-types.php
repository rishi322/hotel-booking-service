...
<head>
    ...
    <!-- Title -->
    <title>Hotel search result - JustStay </title>
    <!-- Bootstrap css -->
                ...
                <div class="col-lg-12">
                    <div class="theme_search_form_area">
                        <div class="theme_search_form_tabbtn">
                            ...
                            $countsql = mysqli_query($conn, "SELECT COUNT(*) AS count FROM room_master where tid = $tid ");
                            if ($countsql) {
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="cruise_search_result_wrapper">
                                ...
                                $sql = mysqli_query($conn, "SELECT h.hid AS hid,h.photos, h.hname,h.city_id,r.adults AS adult,r.description,r.price_per_room,c.city_id,c.city, t.tid, t.tname
                                    FROM hotel_master AS h
                                    JOIN city_tb AS c on h.city_id = c.city_id
                                    JOIN room_master AS r ON h.hid = r.hid
                                    JOIN type_master AS t ON r.tid = t.tid
                                    
                                    WHERE r.total_rooms > 0 and r.tid = $tid

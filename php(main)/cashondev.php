...
$query1 = mysqli_query($conn,"INSERT INTO `booking_tb` (`uid`, `hid`, `tid`, `bdate`, `btime`, `check-in-date`, `check-out-date`, `paytype`, `paystatus`, `paymentkey`, `total amount`, `total_rooms`) VALUES ($uid, $hid, $typeid, '$date', '$time', '$checkindate', '$checkoutdate', 'cod', 'unpaid', '$payid', $amount, $room_need)") or die("query 1");

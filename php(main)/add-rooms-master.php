...
if (isset($_POST['add_hotel'])) {
    ...
    $targetDir = "typeimg/"; // Directory where the file will be moved
    $targetFile = $targetDir . basename($_FILES["file"]["name"]);
    $result = mysqli_query($conn, "INSERT INTO `type_master`( `tname`, `timage`)VALUES ('$tname','$targetFile')");
                                    ...
                                    <form method="POST" enctype="multipart/form-data" insert" class="fade-in">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="inputEmail4" placeholder="Name: XYZ" name="tname">
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $typen = mysqli_query($conn, "select * from type_master");
